...
from tiny_openfold.np import protein
import tiny_openfold.np.residue_constants as rc
from tiny_openfold.utils.rigid_utils import Rotation, Rigid
from tiny_openfold.utils.tensor_utils import (
    batched_gather,
    one_hot,
    tree_map,
    tensor_tree_map,
